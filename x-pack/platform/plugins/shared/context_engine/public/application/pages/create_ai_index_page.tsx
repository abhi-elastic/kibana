...
const createPageDescription = i18n.translate('xpack.contextEngine.createAiIndex.description', {
  defaultMessage:
    'Name the AI index and say what it is for. Sources, storage type and automations are set up on its Overview page.',
});

/** Storage type is chosen on the Overview page; new AI indexes start as an index. */
const DEFAULT_STORAGE_TYPE: AiIndexType = 'index';
...
export const CreateAiIndexPage = () => {
  ...
  const { dest, error: nameError } = validateAiIndexId(DEFAULT_STORAGE_TYPE, id);
